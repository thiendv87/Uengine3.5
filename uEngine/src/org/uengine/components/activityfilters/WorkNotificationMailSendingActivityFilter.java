...
//						+ re.encrypt(taskId) + "&userId=" + re.encrypt(roleMapping.getEndpoint()) + "&passWd=" + re.encrypt(roleMapping.getEndpoint());
				...
				*/
				...
				content.append("		<td>").append(instance.getProcessDefinition().getName().getText()).append("</td>").append("\r\n");
				...
				content.append("		<td colspan='3'>").append(activity.getName().getText()).append("</td>").append("\r\n");
				content.append("	</tr>").append("\r\n");
				...
				mailer.setTitle("[uEngine] " + instance.getName() + " > " + activity.getName().getText());
