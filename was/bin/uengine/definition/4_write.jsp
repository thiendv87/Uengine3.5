...
%>
<input:text name="fld_isu_title" viewMode="0" attributes="<%=fld_isu_title_5%>" default="" /></p>
<p>
	Issue Class : 
 <% 
 ...
 %> 
 <input:select name="fld_isu_cls" optionLabels="<%=fld_isu_cls_1%>" optionValues="<%=fld_isu_cls_2%>" viewMode="0" attributes="<%=fld_isu_cls_0%>" multiple="false"  /> </p>
<p>
	Issue Note :
 <% 
 ...
 %> 
 <input:textarea name="fld_isu_note" viewMode="0" attributes="<%=fld_isu_note_4%>" default="" /></p>
