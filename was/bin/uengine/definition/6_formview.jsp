...
<p>
	Result Note :
 <% 
 java.util.Hashtable fld_rst_note_6 = new java.util.Hashtable(); 
 fld_rst_note_6.put("cols", "80"); 
 fld_rst_note_6.put("rows", "10"); 
 fld_rst_note_6.put("viewmode", "0"); 
 
 %> 
 <input:textarea name="fld_rst_note" attributes="<%=fld_rst_note_6%>" default="" viewMode="<%=InputConstants.VIEW%>" /></p>
