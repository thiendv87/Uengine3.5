...
function attachEdmsDoc(){
    ...
    win = window.open("frm_edms.jsp", "sendedms","width=700, height=476, left=" + iMyWidth + ",top="+ iMyHeight +",screenX="+ iMyWidth +",screenY="+ iMyHeight +",toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no")
}
