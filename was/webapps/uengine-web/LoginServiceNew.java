...
public class LoginServiceNew extends HttpServlet {
	...
	public final static String COOKIE_SAVE_ID = "gpmEngine.Standalone.loggedUserId";
	public final static String COOKIE_AUTO_LOGIN = "gpmEngine.Standalone.AutoLogin";
	...
	public String login(HttpServletRequest request) {
		...
		//String userId ="test";		
	//	String passWd ="test";
		String logOut = "userId =[" + userId + "], passwd = [" + passWd +"]";
