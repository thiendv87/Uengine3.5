...
<%
    ...
    try {
        ...
        try{
            InputStream ris = new FileInputStream(ProcessDefinitionFactory.DEFINITION_ROOT + pdVer + "_edit.form");
            
            ByteArrayOutputStream bao = new ByteArrayOutputStream();
            
            UEngineUtil.copyStream(ris, bao);
            
            formDefinitionValue = bao.toString(GlobalContext.DATABASE_ENCODING/*"ISO-8859-1"*/);
        }catch(Exception e){
            //e.printStackTrace();
...
<script type='text/javascript'>
    $(function() {
        ...
        simpleEditor.renderEditToDiv('simple_editor');
    });
...
<!-- 폼 -->
<div id="simple_editor"><%=formDefinitionValue%></div>
