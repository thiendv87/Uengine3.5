...
<table border="0" cellpadding="0" cellspacing="0" width="100%" xmlns>
	<tr>
		<td height="28" valign="bottom"><span class="sectiontitle">New Class Definition</span>
		</td>
	</tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="20" >
		<td width="150"   class="formtitle">Java Source Code
		</td>
		<td width="10"></td>
		<td width="*" align=left>
...
<input name="objectType" value="class" type="hidden" />
