<%@page 
 	import="javax.naming.InitialContext,javax.rmi.PortableRemoteObject,javax.naming.Context,javax.naming.NamingException,org.uengine.processmanager.*,org.uengine.kernel.*"
 	errorPage="intiateErr.jsp"
%>
<%@page import="org.metaworks.*,org.metaworks.web.*,org.metaworks.inputter.*,java.util.*,java.io.Serializable"%>
...
<%
	if(isValid){
		...
		//for sub process 
		String returningProcess = request.getParameter("returningProcess");
		String returningMessage = request.getParameter("returningMessage");	
