...
<head>
	...
	<script type="text/javascript" src="<%=GlobalContext.WEB_CONTEXT_ROOT%>/scripts/formValidation.js" ></script>
	<script type="text/javascript" src="<%=GlobalContext.WEB_CONTEXT_ROOT%>/scripts/commonScript.js"></script>
