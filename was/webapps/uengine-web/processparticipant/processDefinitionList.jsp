...
<body bgproperties="fixed" background="../images/aquabgr.gif">
...
<%	
	...
	for (int i=0; i<pds.length; i++) {
		...
		if (!("process".equals(definitionRemote.getObjType()))) continue;
...
<form action="viewProcessFlowChart.jsp" method="post" target="innerworkarea">
