...
<div id="bc" style="width:100%; height:100%;" dojoType="dijit.layout.BorderContainer">
	...
	<div dojoType="dijit.layout.ContentPane" region="center" id="centerPane" style="overflow: hidden;">
		...
		<iframe onresize="resizeFrame(this);" onload="changeTitle(this);" style="width: 100%; height: 100%; padding-bottom: 30px;" src="<%=GlobalContext.WEB_CONTEXT_ROOT %>/processparticipant/viewProcessMain.jsp" name="innerworkarea" frameborder="0"></iframe>
	</div>
