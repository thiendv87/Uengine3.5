<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
		...
		<div dojoType="dijit.layout.BorderContainer" id="leftPane" style="width: 100%; background: #fafafa;">
	<!-- Strategy View -->
			...
			<table border="0" width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr height="30">
                        ...
                        <td width="*" align="left" bgcolor="#FFFFFF">
							<input type=text name="nameSearch" style="width:200px;" Onkeydown="searchName(this)" > <input type="button" value="Search" onclick="searchName()">
						</td>
                    </tr>      
                    <tr>
                    ...
                    <tr>
                        <td height="20" colspan="3" align="center"><b><a href="javascript:initialize()"> Initialize</a></b></td>
                    </tr>
                    <tr>
                        <td style="background:#CCC;" height="1" colspan="3"></td>
                    </tr>
			...
			<form id="strategyForm" action="popupDlg.jsp" method="get" style="display:none ;" >
