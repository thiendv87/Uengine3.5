...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="25">
		...
		<td class="formcon"><input type="password" name="password"  dojoType="dijit.form.TextBox" value="" /></td>
	</tr>
	...
	<tr height="25">
		...
		<td class="formcon"><%=empName %>
			<input type="hidden" name="empName" dojoType="dijit.form.TextBox" value="<%=empName %>" />
		</td>
		<td class="formtitle"><strong><%=GlobalContext.getMessageForWeb("Department", loggedUserLocale) %>/<%=GlobalContext.getMessageForWeb("Staff Level", loggedUserLocale) %></strong></td>
		<td class="formcon"><%=sPartOption %>/<%=jikName %>
			<input type="hidden" name="isAdmin" value="<%=isAdmin?"on":""%>" />
			<input type="hidden" name="globalCom" value="<%=sComCode %>">
			<input type="hidden" name="partCode" id="selectPartCode" value="<%=sPartCode %>">
			<input type="hidden" name="jikName" dojoType="dijit.form.TextBox" value="<%=jikName %>" />
		</td>
	</tr>
    <tr><td class="formline" height="1"  colspan="5"></td></tr>
	<tr height="25">
