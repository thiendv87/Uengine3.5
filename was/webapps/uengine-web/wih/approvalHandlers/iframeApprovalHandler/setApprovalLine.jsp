...
<head>
	...
	<script type="text/javascript" src="<%=GlobalContext.WEB_CONTEXT_ROOT%>/js/jslb_ajax.js"></script>
	<script type="text/javascript" src="<%=GlobalContext.WEB_CONTEXT_ROOT%>/js/commonScript.js"></script>
