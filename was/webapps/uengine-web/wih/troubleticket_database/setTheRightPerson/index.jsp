...
<script>
	function searchPeople(inputName){
		var orgPicker = window.open('/html/uengine-web/common/organizationChartPicker.jsp','_new','width=430,height=560,resizable=true,scrollbars=yes');
