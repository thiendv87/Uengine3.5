...
<input:text name="txtA" viewMode="0" attributes="<%=txtA_22%>" default="" /></td>
 ...
 %> <input:radio name="rdoA" viewMode="0" value="1" attributes="<%=rdoA_9%>" default="" />여자</td>
            <td>차량
 <% java.util.Hashtable chkA_0 = new java.util.Hashtable(); 
 chkA_0.put("attrid", "TEMP_ATTR_ID"); 
 %> <input:checkbox name="chkA" viewMode="0" value="on" attributes="<%=chkA_0%>" /> 자가
 <% java.util.Hashtable chkA_2 = new java.util.Hashtable(); 
 chkA_2.put("attrid", "TEMP_ATTR_ID"); 
 %> <input:checkbox name="chkA" viewMode="0" value="on" attributes="<%=chkA_2%>" /> 자녀
 <% java.util.Hashtable chkA_4 = new java.util.Hashtable(); 
 chkA_4.put("attrid", "TEMP_ATTR_ID"); 
 %> <input:checkbox name="chkA" viewMode="0" value="on" attributes="<%=chkA_4%>" /></td>
            <td>
 <% 
 ...
 <input:textarea name="taA" viewMode="0" attributes="<%=taA_20%>" default="" /></td>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="200">
                <tbody>
                    <tr>
                        <td><input:fileupload name="testFile" value="fileupload" viewmode="0" fileclass="general"></input:fileupload></td>
                        <td width="10">
            ...
            <table border="0" cellspacing="2" cellpadding="0" width="200">
                <tbody>
                    <tr>
                        <td><input:calendartag name="caltest" value="calendartag" viewmode="0" objecttype="calendar"></input:calendartag></td>
			...
			<table border="0" cellspacing="2" cellpadding="0" width="200">
				<tbody>
					<tr>
						<td><input:finduser name="fuser" value="finduser" viewmode="0" multiple="false"></input:finduser></td>
...
%>
<input:text name="txtB" viewMode="1" attributes="<%=txtB_23%>" default="" />&nbsp;필드1<br />
<br />

 <% java.util.Hashtable chkB_6 = new java.util.Hashtable(); 
 chkB_6.put("attrid", "TEMP_ATTR_ID"); 
 %> <input:checkbox name="chkB" viewMode="1" value="on" attributes="<%=chkB_6%>" />&nbsp;필드2<br />
<br />

 <% 
 java.util.Hashtable rdoB_10 = new java.util.Hashtable(); 
 rdoB_10.put("attrid", "TEMP_ATTR_ID"); 
 %> <input:radio name="rdoB" viewMode="1" value="A" attributes="<%=rdoB_10%>" default="" />필드3 
 <% 
 java.util.Hashtable rdoB_11 = new java.util.Hashtable(); 
 rdoB_11.put("attrid", "TEMP_ATTR_ID"); 
 %> <input:radio name="rdoB" viewMode="1" value="B" attributes="<%=rdoB_11%>" default="" />필드3<br />
<br />
 ...
 %> 
 <input:textarea name="taB" viewMode="1" attributes="<%=taB_21%>" default="" />&nbsp;필드4<br />
<br />
 ...
 selB_19[0] = "sonata"; 
 %> 
 <input:select name="selB" defaults="<%=selB_19%>" optionLabels="<%=selB_17%>" optionValues="<%=selB_18%>" viewMode="1" attributes="<%=selB_16%>" multiple="false"  /> &nbsp;필드5
