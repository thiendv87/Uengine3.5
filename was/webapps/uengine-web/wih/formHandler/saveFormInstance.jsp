<%
	RequestDispatcher dis = application.getRequestDispatcher((wasIsJBoss ? GlobalContext.WEB_CONTEXT_ROOT : "") + "/wih/formHandler/cachedForms/"+  +"?instanceId=" + processInstance + "&processDefinition=" + processDefinition + "&tracingTag=" + tracingTag + "&isViewMode=yes");
