...
//------------- declaration & initialize -------------------//
	...
	String ckEditorContents = decode(request.getParameter("ckEditorContents"));
	
	if("yes".equals(isCopyInitiate)){
		mappedResult.put("ckeditor1",ckEditorContents);
	}
...
if(document.getElementById('CKeditor')){
	var val = document.getElementById('CKeditor').value;
