...
<div style="height:518px; width:896px; background:url(images/login/bground.gif) no-repeat; top:50%; left:50%; margin-left:-448px; margin-top:-309px; position:absolute; border:0px">
	<div style="margin:90px 0 0 194px; height:61px;">
        ...
        <div style="float:left; margin-top:28px;"><span style="font-size:11px; color:#999; ">Ver 3.5.2 standalone</span></div>    
    </div>
    ...
    <div style=" height:50px; width:369px; margin:53px 0 0 250px;">
    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td width="69%" rowspan="2"><form action="login.jsp" method="post" style=" margin-left:20px;" name="formLogin">
                        <input type="hidden" name="return_to" value="" />
                    
					<input name="userId" style="width:190px"/>
					<!--
                ...
                <td width="16%" rowspan="2"><a href="javascript:" onClick="formLogin.submit();" ><input type="image" src="images/login/b_login.gif"></a></td> </form>
            </tr>
            <tr>
    ...
    <div style=" background:url(images/login/i_blue01.gif) no-repeat 2px;; padding:0 0 0 10px;  margin:28px 0 0 250px; width:380px; color:#808080 ">Administrator (<b>EN</b>) User/Password is <span style="color:#09C;">test / test</span></div>
