...
*/
  ...
  static {
    ...
    _jspx_dependants.add("/organizationmanager/../common/topFrame/indexHead.jsp");
    _jspx_dependants.add("/organizationmanager/../common/topFrame/../header.jsp");
    _jspx_dependants.add("/organizationmanager/../common/topFrame/../headerMethods.jsp");
    _jspx_dependants.add("/organizationmanager/../common/topFrame/../getLoggedUser.jsp");
    _jspx_dependants.add("/organizationmanager/../common/topFrame/../../lib/jquery/importJquery.jsp");
    _jspx_dependants.add("/organizationmanager/../common/topFrame/indexBodyTop.jsp");
    _jspx_dependants.add("/organizationmanager/../common/topFrame/topMenuList.jsp");
    _jspx_dependants.add("/organizationmanager/organizationTreeList.jsp");
    _jspx_dependants.add("/organizationmanager/../common/topFrame/titleBar.jsp");
    _jspx_dependants.add("/organizationmanager/../common/footer.jsp");
  }
...
if(notifiedTaskId!=null){
 ...
 if(isEdition){
      ...
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("        var listtype = \"1\";\r\n");
      out.write("        \r\n");
      out.write("        function allRoleList(){\r\n");
      out.write("            document.selectedItem.type.value = 'all';\r\n");
      out.write("            document.selectedItem.objType.value = 'role';\r\n");
      out.write("            document.selectedItem.submit();\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        function selectedGroup(viewType, item) {\r\n");
      out.write("            var groupForm = document.selectedItem;\r\n");
      out.write("            \r\n");
      out.write("            if (viewType == \"department\")\r\n");
      out.write("            {\r\n");
      out.write("                groupForm.action = \"organizationListDetail.jsp\";\r\n");
      out.write("            }\r\n");
      out.write("            else if (viewType == \"role\")\r\n");
      out.write("            {\r\n");
      out.write("                groupForm.action = \"organizationRoleList.jsp\";\r\n");
      out.write("            }\r\n");
      out.write("            document.selectedItem.type.value = item.type;\r\n");
      out.write("            document.selectedItem.objType.value = item.objType;\r\n");
      out.write("            document.selectedItem.code.value = item.code;\r\n");
      out.write("            document.selectedItem.itemName.value = item.name;\r\n");
      out.write("            document.selectedItem.comCode.value = item.comcode;\r\n");
      out.write("            document.selectedItem.submit();\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        function addUser(item){\r\n");
      out.write("            document.addUser.groupCode.value = item.code;\r\n");
      out.write("            document.addUser.groupName.value = item.name;\r\n");
      out.write("            document.addUser.comName.value = item.comname;\r\n");
      out.write("            document.addUser.comCode.value = item.globalcom;\r\n");
      out.write("            document.addUser.isModification.value = \"false\";\r\n");
      out.write("            document.addUser.submit();\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        function addGroup(item){\r\n");
      out.write("            document.addGroup.comCode.value = item.globalcom;\r\n");
      out.write("            document.addGroup.comName.value = item.name;\r\n");
      out.write("            document.addGroup.type.value = item.type;\r\n");
      out.write("            document.addGroup.parent.value = item.code;\r\n");
      out.write("            document.addGroup.submit();\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        function addRole(item){\r\n");
      out.write("            document.addRole.comCode.value = item.globalcom;\r\n");
      out.write("            document.addRole.submit();\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        function addUserToSelectedRole(item)\r\n");
      out.write("        {\r\n");
      out.write("            var childrenUser = new Array();\r\n");
      out.write("            \r\n");
      out.write("            if (item.children != undefined)\r\n");
      out.write("            {\r\n");
      out.write("                var childrenSize = item.children.length;\r\n");
      out.write("                \r\n");
      out.write("                for(var i = 0; i < childrenSize; i++)\r\n");
      out.write("                {\r\n");
      out.write("                    childrenUser[i] = item.children[i].code;    \r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
      out.write("            //document.addUserToSelectedRole.roles.value = roles;\r\n");
      out.write("            document.addUserToSelectedRole.mappedUser.value = childrenUser;\r\n");
      out.write("            document.addUserToSelectedRole.comCode.value = item.globalcom;\r\n");
      out.write("            document.addUserToSelectedRole.selectedRole.value = item.code;\r\n");
      out.write("            document.addUserToSelectedRole.submit();\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        function deleteObject(itemType, item){\r\n");
      out.write("            if (itemType == 'department' && item.children != undefined)\r\n");
      out.write("            {\r\n");
      out.write("                alert(\"This group have users, delete users first...\");\r\n");
      out.write("            }\r\n");
      out.write("            else\r\n");
      out.write("            {\r\n");
      out.write("                if (confirm(\"Sure?\"))\r\n");
      out.write("                {\r\n");
      out.write("                    if (itemType == 'roleUser')\r\n");
      out.write("                    {\r\n");
      out.write("                        document.deleteObject.roleCode.value = item.rolecode;\r\n");
      out.write("                        document.deleteObject.comCode.value = item.comcode;\r\n");
      out.write("                    }\r\n");
      out.write("                    else\r\n");
      out.write("                    {\r\n");
      out.write("                        document.deleteObject.comCode.value = item.globalcom;\r\n");
      out.write("                    }\r\n");
      out.write("                    \r\n");
      out.write("                    document.deleteObject.itemType.value = itemType;\r\n");
      out.write("                    document.deleteObject.itemId.value = item.code;\r\n");
      out.write("                    \r\n");
      out.write("                    document.deleteObject.submit();\r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        function selectedUser(item){\r\n");
      out.write("            var id = \"\" + (item.code);\r\n");
      out.write("            var splitedId;\r\n");
      out.write("            var selectedId;\r\n");
      out.write("            if(id.indexOf(\":\") > 0){\r\n");
      out.write("                splitedId = id.split(\":\");\r\n");
      out.write("                selectedId = splitedId[1];\r\n");
      out.write("            }else{\r\n");
      out.write("                selectedId = id;\r\n");
      out.write("            }\r\n");
      out.write("            window.innerworkarea.location.href = \"userInfo.jsp?empCode=\" + selectedId;\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("        var appendChildNodeToTree = function(item, treeStore, resultString)\r\n");
      out.write("        {\r\n");
      out.write("            var arrayOfResult = new Array();\r\n");
      out.write("            arrayOfResult = eval(resultString);\r\n");
      out.write("            \r\n");
      out.write("            for (var i = 0; i < arrayOfResult.length; i++)\r\n");
      out.write("            {\r\n");
      out.write("                var result = arrayOfResult[i];\r\n");
      out.write("                \r\n");
      out.write("                if (result.discription != undefined)\r\n");
      out.write("                {\r\n");
      out.write("                    result.discription = decodeURIComponent(result.discription);\r\n");
      out.write("                }\r\n");
      out.write("                \r\n");
      out.write("                if (result.name != undefined)\r\n");
      out.write("                {\r\n");
      out.write("                    result.name = decodeURIComponent(result.name);\r\n");
      out.write("                }\r\n");
      out.write("                \r\n");
      out.write("                var newItem = treeStore.newItem(result, {parent : item, attribute : \"children\"});\r\n");
      out.write("\r\n");
      out.write("                if (result.partname != undefined)\r\n");
      out.write("                {\r\n");
      out.write("                    //result.partname = (decodeURIComponent(result.partname).encodeHtml();\r\n");
      out.write("                    result.partname = decodeURIComponent(result.partname);\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("                if (result.type != \"user\")\r\n");
      out.write("                {\r\n");
      out.write("                    try\r\n");
      out.write("                    {\r\n");
      out.write("                        var tempChild = {code : \"temp_\" + i + result.type + \"_\" + result.code, name : \"tempChildrenForItem\", type : \"temp\"};\r\n");
      out.write("                        if(parseInt(result.cnt) > 0)\r\n");
      out.write("                            treeStore.newItem(tempChild, {parent : newItem, attribute : \"children\"});\r\n");
      out.write("                    }\r\n");
      out.write("                    catch(e)\r\n");
      out.write("                    {\r\n");
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function getDepartmentList(item)\r\n");
      out.write("        {\r\n");
      out.write("            var param = null;\r\n");
      out.write("            var firstChild = item.children[0];\r\n");
      out.write("            if (\"temp\" == firstChild.type)\r\n");
      out.write("            {\r\n");
      out.write("                organizationUserStore.deleteItem(firstChild);\r\n");
      out.write("                var url = WEB_ROOT + \"/organizationmanager/json/getDepartmentsWithUsersToJson.jsp?\";\r\n");
      out.write("                \r\n");
      out.write("                if (item.type == \"company\")\r\n");
      out.write("                {\r\n");
      out.write("                    param = \"comCode=\" + item.code;\r\n");
      out.write("                }\r\n");
      out.write("                else if(item.type == \"department\")\r\n");
      out.write("                {\r\n");
      out.write("                    param = \"parentCode=\" + item.code;\r\n");
      out.write("                }\r\n");
      out.write("                \r\n");
      out.write("                submitAjaxServlet(\r\n");
      out.write("                        url,\r\n");
      out.write("                        \"POST\",\r\n");
      out.write("                        function (resultString) {\r\n");
      out.write("                            appendChildNodeToTree(item, organizationUserStore, resultString);\r\n");
      out.write("                        },\r\n");
      out.write("                        param\r\n");
      out.write("                );\r\n");
      out.write("            }\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("        function getRleList(item)\r\n");
      out.write("        {\r\n");
      out.write("            var param = null;\r\n");
      out.write("            var firstChild = item.children[0];\r\n");
      out.write("            \r\n");
      out.write("            if (\"tempChildrenForItem\" == firstChild.name)\r\n");
      out.write("            {\r\n");
      out.write("                organizationRoleStore.deleteItem(firstChild);\r\n");
      out.write("                var url = WEB_ROOT + \"/organizationmanager/json/roleUsersToJson.jsp?\";\r\n");
      out.write("                \r\n");
      out.write("                if (item.type == \"company\")\r\n");
      out.write("                {\r\n");
      out.write("                    param = \"comCode=\" + item.code;\r\n");
      out.write("                }\r\n");
      out.write("                else if(item.type == \"role\")\r\n");
      out.write("                {\r\n");
      out.write("                    param = \"roleCode=\" + item.code;\r\n");
      out.write("                }\r\n");
      out.write("                \r\n");
      out.write("                submitAjaxServlet(\r\n");
      out.write("                        url,\r\n");
      out.write("                        \"POST\",\r\n");
      out.write("                        function (resultString) {\r\n");
      out.write("                            appendChildNodeToTree(item, organizationRoleStore, resultString);\r\n");
      out.write("                        },\r\n");
      out.write("                        param\r\n");
      out.write("                );\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        function viewinfo(item){\r\n");
      out.write("            if (item.type == 'user') {\r\n");
      out.write("                selectedUser(item);\r\n");
      out.write("            } else {\r\n");
      out.write("                selectedGroup(\"department\", item);\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("     </script>\r\n");
      ...
      out.write("\r\n");
      out.write("<!-- Json -->\r\n");
      out.write("<div dojoType=\"dojo.data.ItemFileWriteStore\" jsId=\"organizationUserStore\" url=\"json/jsonConfig.json\"></div>\r\n");
      out.write("<div dojoType=\"dijit.tree.ForestStoreModel\" jsId=\"organizationUserModel\" store=\"organizationUserStore\" childrenAttrs=\"children\" ></div>\r\n");
      out.write("               \r\n");
      out.write("<div dojoType=\"dojo.data.ItemFileWriteStore\" jsId=\"organizationRoleStore\" url=\"json/jsonConfig.json\"></div>\r\n");
      out.write("\r\n");
      out.write("<!-- Menu -->\r\n");
      out.write("<ul dojoType=\"dijit.Menu\" id=\"user_menu\" style=\"display: none;\">\r\n");
      out.write("    <li dojoType=\"dijit.MenuItem\" onClick=\"listtype='1';addGroup(global_tn.item);\">Add Group</li>\r\n");
      out.write("    <li dojoType=\"dijit.MenuItem\" onClick=\"listtype='1';deleteObject('department', global_tn.item);\">Delete Group</li>\r\n");
      out.write("    <li dojoType=\"dijit.MenuItem\" onClick=\"listtype='1';addUser(global_tn.item);\">Add user</li>\r\n");
      out.write("    <li dojoType=\"dijit.MenuItem\" onClick=\"listtype='1';deleteObject('groupUser', global_tn.item);\">Delete user</li>\r\n");
      out.write("    <li dojoType=\"dijit.MenuItem\" onClick=\"listtype='1';document.location.reload()\">Refresh</li>\r\n");
      out.write("    <li dojoType=\"dijit.MenuItem\" onClick=\"listtype='1';viewinfo(global_tn.item);\">View Info</li>\r\n");
      out.write("</ul>\r\n");
      out.write("\r\n");
      out.write("<ul dojoType=\"dijit.Menu\" id=\"role_menu\" style=\"display: none;\">\r\n");
      out.write("    <li dojoType=\"dijit.MenuItem\" onClick=\"listtype='2';addRole(global_tn.item);\">Add Role</li>\r\n");
      out.write("    <li dojoType=\"dijit.MenuItem\" onClick=\"listtype='2';deleteObject('role', global_tn.item);\">Delete Role</li>\r\n");
      out.write("    <li dojoType=\"dijit.MenuItem\" onClick=\"listtype='2';addUserToSelectedRole(global_tn.item);\">Add User</li>\r\n");
      out.write("    <li dojoType=\"dijit.MenuItem\" onClick=\"listtype='2';deleteObject('roleUser', global_tn.item);\">Delete User</li>\r\n");
      out.write("    <li dojoType=\"dijit.MenuItem\" onClick=\"listtype='2';document.location.reload()\">Refresh</li>\r\n");
      out.write("</ul>\r\n");
      out.write("\r\n");
    ...
    if("2".equals(listtype))
      ...
      out.write("        <!-- User manage Accordion -->\r\n");
      out.write("        \r\n");
      out.write("        <div dojoType=\"dijit.layout.AccordionPane\"  selected=");
      out.print(userList );
      out.write(" title=\"");
      out.print(GlobalContext.getLocalizedMessageForWeb("user_manager",loggedUserLocale,"User manager") );
      out.write("\">\r\n");
      out.write("            <div dojoType=\"dijit.Tree\" id=\"userListTree\" model=\"organizationUserModel\" showRoot=\"false\" openOnClick=\"false\" >\r\n");
      out.write("                <script type=\"dojo/connect\">\r\n");
      out.write("                var menuEmpty = dijit.byId(\"user_menu\");\r\n");
      out.write("                \r\n");
      ...
      out.write("\r\n");
      out.write("                    if (\r\n");
      out.write("                            global_tn.item.type != \"user\"\r\n");
      out.write("                            && global_tn.item.type != \"department\"\r\n");
      out.write("                            && global_tn.item.type != \"company\"\r\n");
      out.write("                    ) {\r\n");
      ...
      out.write("                                    || i.id == \"dijit_MenuItem_5\"\r\n");
 if (!loggedUserIsMaster) { 
      ...
      out.write("                            }\r\n");
      out.write("                        });\r\n");
      out.write("                    } else if (global_tn.item.type == \"company\") {\r\n");
      out.write("                        menuEmpty.getChildren().forEach (\r\n");
      out.write("                            function(i) {\r\n");
      out.write("                                if (i.id == \"dijit_MenuItem_2\" || i.id == \"dijit_MenuItem_3\" || i.id == \"dijit_MenuItem_5\") {\r\n");
      out.write("                                    i.setDisabled(true);\r\n");
      out.write("                                } else {\r\n");
      out.write("                                    i.setDisabled(false);\r\n");
      out.write("                                }\r\n");
      out.write("                            }\r\n");
      out.write("                        );\r\n");
      out.write("                    } else if (global_tn.item.type == \"department\") {\r\n");
      out.write("                        menuEmpty.getChildren().forEach (\r\n");
      out.write("                            function(i) {\r\n");
      out.write("                                if (i.id == \"dijit_MenuItem_3\") {\r\n");
      out.write("                                    i.setDisabled(true);\r\n");
      out.write("                                } else {\r\n");
      out.write("                                    i.setDisabled(false);\r\n");
      out.write("                                }\r\n");
      out.write("                            }\r\n");
      out.write("                        );\r\n");
      out.write("                    } else if (global_tn.item.type == \"user\") {\r\n");
      out.write("                        menuEmpty.getChildren().forEach(function(i){\r\n");
      out.write("                            if (i.id == \"dijit_MenuItem_0\" || i.id == \"dijit_MenuItem_1\" || i.id==\"dijit_MenuItem_2\") {\r\n");
      out.write("                                i.setDisabled(true);\r\n");
      out.write("                            } else {\r\n");
      out.write("                                i.setDisabled(false);\r\n");
      out.write("                            }\r\n");
      ...
      out.write("                    var ObjType=\"\";\r\n");
      out.write("                    \r\n");
      out.write("                    if (item == this.model.root) {\r\n");
      out.write("                        ObjType = \"organization\";\r\n");
      out.write("                    } else if (organizationUserStore.getValue(item, \"type\") == \"root\") {\r\n");
      out.write("                        ObjType=\"organization\";\r\n");
      out.write("                    } else {\r\n");
      out.write("                        ObjType = organizationUserStore.getValue(item, \"type\");\r\n");
      out.write("                    }\r\n");
      out.write("                    \r\n");
      out.write("                    if (ObjType == \"user\") {\r\n");
      out.write("                        ObjType = \"userIcon\";\r\n");
      out.write("                    } else if (ObjType == \"company\") {\r\n");
      out.write("                        ObjType = \"comIcon\";\r\n");
      out.write("                    } else if (ObjType == \"department\") {\r\n");
      out.write("                        ObjType = \"deptIcon\";\r\n");
      out.write("                    } else if (ObjType == \"organization\") {\r\n");
      out.write("                        ObjType = \"organizationIcon\";\r\n");
      out.write("                    } else {\r\n");
      ...
      out.write("                    getDepartmentList(item);\r\n");
      out.write("                </script>\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("\r\n");
      ...
      out.print(roleList );
      out.write(" title=\"");
      out.print(GlobalContext.getLocalizedMessageForWeb("role_manager", loggedUserLocale, "Role manager") );
      out.write("\">\r\n");
      out.write("            <div dojoType=\"dijit.Tree\" id=\"roleList\" store=\"organizationRoleStore\" childrenAttr=\"children\" showRoot=\"false\" openOnClick=\"false\" >\r\n");
      out.write("                <script type=\"dojo/connect\">\r\n");
      out.write("                var menuEmpty = dijit.byId(\"role_menu\");\r\n");
      out.write("                \r\n");
      out.write("                menuEmpty.bindDomNode(this.domNode);\r\n");
      out.write("                \r\n");
      out.write("                dojo.connect(menuEmpty, \"_openMyself\", this, function(e)\r\n");
      out.write("                {\r\n");
      out.write("                    global_tn = dijit.getEnclosingWidget(e.target);\r\n");
      out.write("                    var itemType = global_tn.item.type;\r\n");
      out.write("                    \r\n");
      out.write("                    if(itemType != \"role\" && itemType != \"user\") {\r\n");
      out.write("                        menuEmpty.getChildren().forEach(function(i){ \r\n");
      out.write("                            if(i.id==\"dijit_MenuItem_7\" || i.id==\"dijit_MenuItem_9\"){\r\n");
      out.write("                               i.setDisabled(true); \r\n");
      out.write("                             }else{\r\n");
      out.write("                               i.setDisabled(false); \r\n");
      out.write("                             }\r\n");
      out.write("                        });\r\n");
      out.write("                    }else if(itemType == \"role\"){\r\n");
      out.write("                        menuEmpty.getChildren().forEach(function(i){\r\n");
      out.write("                            if(i.id == \"dijit_MenuItem_6\" || i.id==\"dijit_MenuItem_9\" ){\r\n");
      out.write("                                i.setDisabled(true);\r\n");
      out.write("                            }else{\r\n");
      out.write("                                i.setDisabled(false);\r\n");
      out.write("                            }\r\n");
      out.write("                        });\r\n");
      out.write("                    }else if(itemType == \"user\"){\r\n");
      out.write("                        menuEmpty.getChildren().forEach(function(i){\r\n");
      out.write("                            if(i.id == \"dijit_MenuItem_6\" || i.id == \"dijit_MenuItem_7\" || i.id==\"dijit_MenuItem_8\"){\r\n");
      out.write("                                i.setDisabled(true);\r\n");
      out.write("                            }else{\r\n");
      out.write("                                i.setDisabled(false);\r\n");
      out.write("                            }\r\n");
      ...
      out.write("                    else\r\n");
      out.write("                    {\r\n");
      out.write("                        selectedGroup(\"role\", item);\r\n");
      out.write("                    }\r\n");
      out.write("                </script>\r\n");
      out.write("                <script type=\"dojo/method\" event=\"onOpen\" args=\"item, node\">\r\n");
      out.write("                    getRleList(item);\r\n");
      out.write("                </script>\r\n");
      out.write("                <script type=\"dojo/method\" event=\"getIconClass\" args=\"item, opened\">\r\n");
      out.write("                    var IconType=\"\";\r\n");
      out.write("                    if(item != null){\r\n");
      out.write("                        if(item.type == \"root\"){\r\n");
      out.write("                            IconType = \"organizationIcon\";\r\n");
      out.write("                        } else if(item.type == \"company\"){\r\n");
      out.write("                            IconType = \"comIcon\";\r\n");
      out.write("                        } else if (item.type == \"role\") {\r\n");
      out.write("                            IconType = \"roleIcon\";\r\n");
      out.write("                        } else if (item.type == \"user\") {\r\n");
      ...
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<form name=\"selectedItem\" action=\"organizationListDetail.jsp\" method=\"post\" target=\"innerworkarea\">\r\n");
      out.write("    <input type=\"hidden\" name=\"type\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"objType\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"code\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"itemName\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"roleCode\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"comCode\" />\r\n");
      out.write("</form>\r\n");
      out.write("\r\n");
      out.write("<form name=\"addUser\" action=\"addUser.jsp\" method=\"post\" target=\"innerworkarea\">\r\n");
      out.write("    <input type=\"hidden\" name=\"groupCode\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"groupName\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"comCode\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"comName\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"isModification\" />\r\n");
      out.write("</form>\r\n");
      out.write("\r\n");
      out.write("<form name=\"addGroup\" action=\"addGroup.jsp\" method=\"post\" target=\"innerworkarea\">\r\n");
      out.write("    <input type=\"hidden\" name=\"comCode\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"comName\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"parent\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"type\" />\r\n");
      out.write("</form>\r\n");
      out.write("\r\n");
      out.write("<form name=\"addRole\" action=\"addRole.jsp\" method=\"post\" target=\"innerworkarea\">\r\n");
      out.write("    <input type=\"hidden\" name=\"comCode\" />\r\n");
      out.write("</form>\r\n");
      out.write("\r\n");
      out.write("<form name=\"addUserToSelectedRole\" action=\"addUserToSelectedRole.jsp\" method=\"post\" target=\"innerworkarea\">\r\n");
      out.write("    <input type=\"hidden\" name=\"roles\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"comCode\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"mappedUser\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"selectedRole\" />\r\n");
      out.write("</form>\r\n");
      out.write("\r\n");
      out.write("<form name=\"deleteObject\" action=\"deleteObjectAction.jsp\" method=\"post\" target=\"innerworkarea\">\r\n");
      out.write("    <input type=\"hidden\" name=\"itemType\" />\r\n");
      ...
      out.write("</div>");
      out.write("\r\n");
      out.write("\t     <iframe onresize=\"resizeFrame(this);\" onload=\"changeTitle(this);\" style=\"width: 100%; height: 100%; padding-bottom: 30px;\" \r\n");
      out.write("\t     src=\"organizationListDetail.jsp\" name=\"innerworkarea\" frameborder=\"0\"></iframe>\r\n");
      out.write("\t</div>\r\n");
