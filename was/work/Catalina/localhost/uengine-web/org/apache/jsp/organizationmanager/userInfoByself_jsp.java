...
public final class userInfoByself_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (isRegUser) {
	...
	rmClsName = org.uengine.kernel.RoleMapping.USE_CLASS.getName();
		...
		try {
			...
			if (rs.next()) {
				...
				while (rsPart.next()) {
					...
					sPartCode += rsPart.getString("partcode").equals(partCode) ? rsPart.getString("partcode"): "";
					sPartOption += rsPart.getString("partcode").equals(partCode) ? rsPart.getString("partname"): "";
				}
				...
				while (rsCom.next()) {
					...
					sComCode += rsCom.getString("comcode").equals(globalCom) ? rsCom.getString("comcode"): "";
					sComOption += rsCom.getString("comcode").equals(globalCom) ? rsCom.getString("comname"): "";
				}
      ...
      out.write("\t</style>\r\n");
      out.write("\t\r\n");
      out.write("\t<script type=\"text/javascript\" src=\"../dojo/dojo/dojo.js\"\r\n");
      out.write("\t\tdjConfig=\"parseOnLoad: true, isDebug: false, defaultTestTheme: 'soria'\"></script>\r\n");
      ...
      out.write("\t\t<td rowspan=\"9\" align=\"center\">\r\n");
      ...
      out.write("</strong></td>\r\n");
      out.write("\t\t<td class=\"formcon\"><input type=\"password\" name=\"password\"  dojoType=\"dijit.form.TextBox\" value=\"\" /></td>\r\n");
      out.write("\t</tr>\r\n");
      ...
      out.print(empName );
      out.write("\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"empName\" dojoType=\"dijit.form.TextBox\" value=\"");
      out.print(empName );
      out.write("\" />\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t\t<td class=\"formtitle\"><strong>");
      ...
      out.print(isAdmin?"on":"");
      out.write("\" />\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"globalCom\" value=\"");
      out.print(sComCode );
      out.write("\">\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"partCode\" id=\"selectPartCode\" value=\"");
      out.print(sPartCode );
      out.write("\">\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"jikName\" dojoType=\"dijit.form.TextBox\" value=\"");
      out.print(jikName );
      out.write("\" />\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t</tr>\r\n");
