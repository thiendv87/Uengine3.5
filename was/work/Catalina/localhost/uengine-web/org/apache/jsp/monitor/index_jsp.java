...
import org.uengine.ui.monitor.filter.MonitorFilterList;
import org.uengine.ui.monitor.filter.MonitorFilter;
import org.uengine.util.UEngineUtil;
...
*/
  ...
  static {
    ...
    _jspx_dependants.add("/monitor/../common/topFrame/indexHead.jsp");
    _jspx_dependants.add("/monitor/../common/topFrame/../header.jsp");
    _jspx_dependants.add("/monitor/../common/topFrame/../headerMethods.jsp");
    _jspx_dependants.add("/monitor/../common/topFrame/../getLoggedUser.jsp");
    _jspx_dependants.add("/monitor/../common/topFrame/../../lib/jquery/importJquery.jsp");
    _jspx_dependants.add("/monitor/../common/topFrame/indexBodyTop.jsp");
    _jspx_dependants.add("/monitor/../common/topFrame/topMenuList.jsp");
    _jspx_dependants.add("/monitor/monitorTreeList.jsp");
    _jspx_dependants.add("/monitor/../common/topFrame/titleBar.jsp");
    _jspx_dependants.add("/monitor/../common/footer.jsp");
  }
...
if(notifiedTaskId!=null){
 ...
 if(isEdition){
      ...
      out.write("\t\t\t\t\ttitle=\"");
      out.print(GlobalContext.getMessageForWeb("monitor.title", loggedUserLocale));
      out.write("\" \r\n");
...
MonitorFilter[] monitorFilters = mfl.getMonitorFilters();
      ...
      out.write("    document.selectedItem.endpoint.value = \"\";\r\n");
      out.write("    document.selectedItem.processDefinitionId.value = \"\";\r\n");
      out.write("    document.selectedItem.processDefinitionName.value = \"\";\r\n");
      out.write("    document.selectedItem.orderby.value = \"\";\r\n");
      out.write("    document.selectedItem.status.value = \"\";\r\n");
      out.write("    document.selectedItem.partCode.value = \"\";\r\n");
      out.write("    document.selectedItem.roleCode.value = \"\";\r\n");
      out.write("    document.selectedItem.tag.value = \"\";\r\n");
      out.write("    document.selectedItem.filter.value = \"\";\r\n");
      out.write("    document.selectedItem.filterName.value = \"\";\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function viewGanttChart(item, orderby) {\r\n");
      out.write("    clearForm();\r\n");
      out.write("    \r\n");
      out.write("    if (item != null) {\r\n");
      out.write("\t    if (orderby == \"resource\") {                \r\n");
      out.write("\t        document.selectedItem.endpoint.value = item.code;\r\n");
      out.write("\t    } else if (orderby == \"instance\") {\r\n");
      out.write("\t        document.selectedItem.processDefinitionId.value = item.id;\r\n");
      out.write("\t        document.selectedItem.processDefinitionName.value = item.name;\r\n");
      out.write("\t    }\r\n");
      out.write("    }\r\n");
      out.write("    \r\n");
      out.write("    document.selectedItem.filter.value = \"no\";\r\n");
      out.write("    \r\n");
      out.write("    document.selectedItem.orderby.value = orderby;\r\n");
      out.write("    document.selectedItem.submit();\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function addFilter(){\r\n");
      out.write("    var url = \"../processparticipant/commonfilter/monitor/dlgMonitorAddFilter.jsp\";\r\n");
      out.write("    window.open(url,'','top=100,left=100,width=600,height=470,scrollbars=no');\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function deleteFilter(UID){\r\n");
      out.write("    result = confirm(\"Are you sure to delete this filter?\");\r\n");
      out.write("    if(result==true){\r\n");
      out.write("        var url = \"../processparticipant/commonfilter/monitor/deleteMonitorFilter.jsp?filterUID=\"+UID;\r\n");
      out.write("        window.open(url,'','top=100,left=100,width=600,height=300,resizable=true,scrollbars=yes');\r\n");
      out.write("    }\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function filterGanttChart(defId, status, partCode, roleCode, tag, defName, filterName) {\r\n");
      out.write("\tclearForm();\r\n");
      out.write("\t\r\n");
      out.write("    document.selectedItem.orderby.value = \"instance\";\r\n");
      out.write("    document.selectedItem.processDefinitionId.value = defId;\r\n");
      out.write("    document.selectedItem.status.value = status;\r\n");
      out.write("    document.selectedItem.partCode.value = partCode;\r\n");
      out.write("    document.selectedItem.roleCode.value = roleCode;\r\n");
      out.write("    document.selectedItem.tag.value = tag;\r\n");
      out.write("    document.selectedItem.processDefinitionName.value = defName;\r\n");
      out.write("    document.selectedItem.filter.value = \"yes\";\r\n");
      out.write("    document.selectedItem.filterName.value = filterName;\r\n");
      out.write("    \r\n");
      out.write("    document.selectedItem.submit();\r\n");
      out.write("}\r\n");
      out.write("//-->\r\n");
      ...
      out.write("\r\n");
      out.write("<!-- Json -->\r\n");
      out.write("<div dojoType=\"dojo.data.ItemFileWriteStore\" jsId=\"organizationUserStore\" url=\"../organizationmanager/organizationUserListJson.jsp\"></div>\r\n");
      out.write("<div dojoType=\"dojo.data.ItemFileReadStore\" jsId=\"continentStore\" url=\"../processparticipant/processListForParticipantJson.jsp\"></div>\r\n");
      ...
      out.write("\r\n");
      out.write("<div dojoType=\"dijit.layout.LayoutContainer\" style=\"height: 100%;\">\r\n");
      ...
      out.print(GlobalContext.getMessageForWeb("monitor.instance", loggedUserLocale) );
      out.write("\">\r\n");
      out.write("            <div dojoType=\"dijit.Tree\" id=\"tree2\" model=\"continentModel\" showRoot=\"true\" onClick=\"true\">\r\n");
      out.write("                    <script type=\"dojo/method\" event=\"getIconClass\" args=\"item, opened\">\r\n");
      out.write("                        if (item == this.model.root) {\r\n");
      ...
      out.write("                        if(item == this.model.root){\r\n");
      out.write("                            viewGanttChart(null, \"instance\");\r\n");
      out.write("                        }\r\n");
      out.write("                        if (item.obj != \"folder\") {\r\n");
      out.write("                            viewGanttChart(item, \"instance\");\r\n");
      out.write("                        }\r\n");
      out.write("                    </script>\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("        \r\n");
      out.write("        <!-- User manage Accodion -->\r\n");
      out.write("        <div dojoType=\"dijit.layout.AccordionPane\" title=\"");
      out.print(GlobalContext.getMessageForWeb("monitor.user", loggedUserLocale) );
      out.write("\">\r\n");
      out.write("            <div dojoType=\"dijit.Tree\" id=\"userList\" store=\"organizationUserStore\" childrenAttr=\"children\" query=\"{type:'com'}\" label=\"");
      out.print(GlobalContext.getLocalizedMessageForWeb("user",loggedUserLocale,"User") );
      out.write("\">\r\n");
      out.write("                <script type=\"dojo/method\" event=\"getIconClass\" args=\"item, opened\">\r\n");
      out.write("                    var IconType=\"main\";\r\n");
      out.write("                    if(item != null){\r\n");
      out.write("                        if (item.type == \"main\"){\r\n");
      out.write("                            IconType = \"main\";\r\n");
      out.write("                        } else {\r\n");
      out.write("                            IconType = item.type;\r\n");
      out.write("                        }\r\n");
      out.write("                    }\r\n");
      out.write("\r\n");
      out.write("                    if (IconType == \"main\") {\r\n");
      out.write("                        IconType = opened ? \"customFolderOpenedIcon\" : \"customFolderClosedIcon\";\r\n");
      out.write("                    } else if(IconType == \"com\") {\r\n");
      out.write("                        IconType = \"comIcon\";\r\n");
      out.write("                    } else if(IconType == \"dept\") {\r\n");
      out.write("                        IconType = \"deptIcon\";\r\n");
      out.write("                    } else {\r\n");
      out.write("                        IconType = \"userIcon\";\r\n");
      out.write("                    }\r\n");
      out.write("\r\n");
      out.write("                    return IconType;\r\n");
      out.write("                </script>\r\n");
      out.write("                <script type=\"dojo/method\" event=\"onClick\" args=\"item\">\r\n");
      out.write("                    if (item.type == 'user') {\r\n");
      out.write("                        viewGanttChart(item, \"resource\");\r\n");
      out.write("                    }\r\n");
      out.write("                </script>\r\n");
      out.write("            </div>          \r\n");
      out.write("        </div>\r\n");
      out.write("\r\n");
      out.write("        <div dojoType=\"dijit.layout.AccordionPane\" title=\"");
      out.print(GlobalContext.getMessageForWeb("monitor.filter", loggedUserLocale) );
      out.write("\" class=\"menuList\">\r\n");
      ...
      out.write("\r\n");
      out.write("            <ul id=\"dojoList\" >\r\n");
      out.write("                <li>\r\n");
      out.write("                    <a href=\"#\" onclick=\"filterGanttChart('");
      out.print(defId);
      out.write("', '");
      out.print(status);
      out.write("', '");
      ...
      out.print(defName );
      out.write("', '");
      out.print(monitorFilters[i].getFilterName());
      out.write("');\">");
      out.print(monitorFilters[i].getFilterName());
      out.write("</a>&nbsp;&nbsp;\r\n");
      out.write("                    <img src=\"");
      out.print(GlobalContext.WEB_CONTEXT_ROOT);
      out.write("/images/Common/b_smalldel.gif\" width=\"29\" height=\"11\" onClick=\"javascript:deleteFilter('");
      out.print(monitorFilters[i].getFilterUId());
      out.write("')\" style=\"cursor:pointer; right:15px; position:absolute; \">\r\n");
      out.write("                </li>\r\n");
      out.write("            </ul>\r\n");
      ...
      out.write("\r\n");
      out.write("            <ul style=\" border-bottom:1px dotted #CCCCCC; background:#FFF none; \">\r\n");
      out.write("                <li style=\" background:#FFF none; border:none; padding:2px; cursor:pointer; text-align:center;\" onClick=\"javascript:addFilter();\">\r\n");
      out.write("                   <img src=\"");
      out.print(GlobalContext.WEB_CONTEXT_ROOT);
      out.write("/images/Common/addfilter.gif\" width=\"97\" height=\"19\"/>\r\n");
      out.write("                </li>\r\n");
      out.write("            </ul>\r\n");
      out.write("        </div>\r\n");
      out.write("    </div>\r\n");
      out.write("</div>        \r\n");
      out.write("\r\n");
      out.write("<form name=\"selectedItem\" action=\"ganttChart.jsp\" method=\"post\" target=\"innerworkarea\">\r\n");
      out.write("    <input type=\"hidden\" name=\"processDefinitionName\" id=\"processDefinitionName\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"processDefinitionId\" id=\"processDefinitionId\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"orderby\" id=\"orderby\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"endpoint\" id=\"endpoint\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"status\" id=\"status\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"partCode\" id=\"partCode\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"roleCode\" id=\"roleCode\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"tag\" id=\"tag\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"filter\" id=\"filter\" />\r\n");
      out.write("    <input type=\"hidden\" name=\"filterName\" id=\"filterName\" />\r\n");
      out.write("</form>\r\n");
      out.write("\r\n");
      out.write("</div>");
      out.write("\r\n");
      ...
      out.write("</div>");
      out.write("\r\n");
      out.write("\t     <iframe onresize=\"resizeFrame(this);\" onload=\"changeTitle(this);\" style=\"width: 100%; height: 100%; padding-bottom: 30px;\" src=\"ganttChart.jsp\" name=\"innerworkarea\" frameborder=\"0\"></iframe>\r\n");
      out.write("\t</div>\r\n");
