...
*/
  ...
  static {
    ...
    _jspx_dependants.add("/processparticipant/../common/topFrame/indexHead.jsp");
    _jspx_dependants.add("/processparticipant/../common/topFrame/../header.jsp");
    _jspx_dependants.add("/processparticipant/../common/topFrame/../headerMethods.jsp");
    _jspx_dependants.add("/processparticipant/../common/topFrame/../getLoggedUser.jsp");
    _jspx_dependants.add("/processparticipant/../common/topFrame/../../lib/jquery/importJquery.jsp");
    _jspx_dependants.add("/processparticipant/../common/topFrame/indexBodyTop.jsp");
    _jspx_dependants.add("/processparticipant/../common/topFrame/topMenuList.jsp");
    _jspx_dependants.add("/processparticipant/processDefinitionTreeList.jsp");
    _jspx_dependants.add("/processparticipant/../common/topFrame/titleBar.jsp");
    _jspx_dependants.add("/processparticipant/../common/footer.jsp");
  }
...
if (isRegUser) {
	...
	else
	{
      ...
      out.write("\r\n");
      out.write("\t<script type=\"text/javascript\">\r\n");
      out.write("\t\tdojo.require(\"dojox.fx.easing\");\r\n");
      out.write("\t</script>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
...
if(notifiedTaskId!=null){
 ...
 if(isEdition){
	...
	String target = request.getParameter("target");
      ...
      out.write("<style type=\"text/css\">\r\n");
      out.write("\tBODY {\r\n");
      out.write("\t\tbackground:url(images/empty.gif) #ffffff ;\r\n");
      ...
      out.write("</style>\r\n");
      out.write("\r\n");
      out.write("<div class=\"tundra\">\r\n");
      out.write("\r\n");
      out.write("<div dojoType=\"dojo.data.ItemFileReadStore\" jsId=\"continentStore\" url=\"processFolderListForParticipantJson.jsp\"></div>\r\n");
      out.write("<div dojoType=\"dijit.tree.ForestStoreModel\" jsId=\"continentModel\" store=\"continentStore\" rootId=\"continentRoot\" rootLabel=\"Definitions\" childrenAttrs=\"children\">\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<!-- ############################################ -->\r\n");
      ...
      out.write("\t\t\t\t\t\tdocument.viewProcessInformation.folderId.value = item.id;\r\n");
      out.write("\t\t\t\t\t\tdocument.viewProcessInformation.folderName.value = item.name;\r\n");
      out.write("\t\t\t\t\t\tdocument.viewProcessInformation.submit();\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\tif(item == this.model.root){\r\n");
      out.write("\t\t\t\t\t\tdocument.viewProcessInformation.folderId.value = \"-1\";\r\n");
      out.write("\t\t\t\t\t\tdocument.viewProcessInformation.folderName.value = \"Definition\";\r\n");
      out.write("\t\t\t\t\t\tdocument.viewProcessInformation.submit();\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t</script>\r\n");
      out.write("\t\t\t</div>\r\n");
      ...
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<form name=\"viewProcessDefinition\" action=\"viewProcessFlowChart.jsp\" method=\"post\" target=\"innerworkarea\">\r\n");
      out.write("\t<input type=\"hidden\" name=\"processDefinition\">\r\n");
      out.write("\t<input type=\"hidden\" name=\"folder\">\r\n");
      out.write("</form>\r\n");
      out.write("\r\n");
      out.write("<form name=\"viewProcessInformation\" action=\"viewProcessInfo.jsp\" method=\"post\" target=\"innerworkarea\">\r\n");
      ...
      out.print(GlobalContext.WEB_CONTEXT_ROOT );
      out.write("/processparticipant/viewProcessMain.jsp\" name=\"innerworkarea\" frameborder=\"0\"></iframe>\r\n");
      out.write("\t</div>\r\n");
