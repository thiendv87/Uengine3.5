...
*/
  ...
  static {
    ...
    _jspx_dependants.add("/common/topFrame/indexHead.jsp");
    _jspx_dependants.add("/common/topFrame/../header.jsp");
    _jspx_dependants.add("/common/topFrame/../headerMethods.jsp");
    _jspx_dependants.add("/common/topFrame/../getLoggedUser.jsp");
    _jspx_dependants.add("/common/topFrame/../../lib/jquery/importJquery.jsp");
    _jspx_dependants.add("/common/topFrame/indexBodyTop.jsp");
    _jspx_dependants.add("/common/topFrame/topMenuList.jsp");
...
if(notifiedTaskId!=null){
 ...
 if(isEdition){
      ...
      out.write("</div>");
      out.write("\r\n");
      out.write("\t<div dojoType=\"dijit.layout.ContentPane\" region=\"center\" id=\"centerPane\">\r\n");
      out.write("\t     <iframe onresize=\"resizeFrame(this);\" style=\"width: 100%; height: 100%;\" src=\"main.jsp\" name=\"innerworkarea\" frameborder=\"0\"></iframe>\r\n");
      out.write("\t</div>\r\n");
