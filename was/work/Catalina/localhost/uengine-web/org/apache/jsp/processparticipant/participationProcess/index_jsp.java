package org.apache.jsp.processparticipant.participationProcess;
...
*/
  ...
  static {
    ...
    _jspx_dependants.add("/processparticipant/participationProcess/../../common/topFrame/indexHead.jsp");
    _jspx_dependants.add("/processparticipant/participationProcess/../../common/topFrame/../header.jsp");
    _jspx_dependants.add("/processparticipant/participationProcess/../../common/topFrame/../headerMethods.jsp");
    _jspx_dependants.add("/processparticipant/participationProcess/../../common/topFrame/../getLoggedUser.jsp");
    _jspx_dependants.add("/processparticipant/participationProcess/../../common/topFrame/../../lib/jquery/importJquery.jsp");
    _jspx_dependants.add("/processparticipant/participationProcess/../../common/topFrame/indexBodyTop.jsp");
    _jspx_dependants.add("/processparticipant/participationProcess/../../common/topFrame/topMenuList.jsp");
    _jspx_dependants.add("/processparticipant/participationProcess/wl2_menu.jsp");
    _jspx_dependants.add("/processparticipant/participationProcess/../../common/topFrame/titleBar.jsp");
    _jspx_dependants.add("/processparticipant/participationProcess/../../common/footer.jsp");
  }
...
if(notifiedTaskId!=null){
 ...
 if(isEdition){
	...
	WorkListFilter[] workitemFilters = wfl.getWorkItemFilters();
      ...
      out.write("\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("/*remove add filter function*/\r\n");
      out.write(" /* \r\n");
      ...
      out.write("    <!--\r\n");
      out.write("\t\t<h3><a href=\"#\">");
      out.print(GlobalContext.getMessageForWeb("msg.Processes", loggedUserLocale));
      out.write("</a></h3>\r\n");
      out.write("    -->\r\n");
      out.write("\t\t<div>\r\n");
      out.write("        <ul>\r\n");
      out.write("            <li><a href=\"");
      out.print(GlobalContext.WEB_CONTEXT_ROOT);
      out.write("/processparticipant/worklist/wl2_instanceList.jsp?filtering=0&currentPage=1\" target=\"innerworkarea\">");
      out.print(GlobalContext.getMessageForWeb("Running Process", loggedUserLocale));
      out.write("</a></li>\r\n");
      out.write("        </ul>\r\n");
      out.write("        <ul>\r\n");
      out.write("            <li><a href=\"");
      out.print(GlobalContext.WEB_CONTEXT_ROOT);
      out.write("/processparticipant/worklist/wl2_instanceList.jsp?filtering=1&currentPage=1\" target=\"innerworkarea\">");
      out.print(GlobalContext.getMessageForWeb("Completed Process", loggedUserLocale));
      out.write("</a></li>\r\n");
      out.write("        </ul>\r\n");
      out.write("        <ul>\r\n");
      out.write("            <li><a href=\"");
      out.print(GlobalContext.WEB_CONTEXT_ROOT);
      out.write("/processparticipant/worklist/wl2_instanceList.jsp?filtering=2&currentPage=1\" target=\"innerworkarea\">");
      out.print(GlobalContext.getMessageForWeb("Stopped Process", loggedUserLocale));
      out.write("</a></li>\r\n");
      out.write("        </ul>\r\n");
      out.write("        <ul>\r\n");
      out.write("            <li><a href=\"");
      out.print(GlobalContext.WEB_CONTEXT_ROOT);
      out.write("/processparticipant/worklist/wl2_instanceList.jsp?filtering=0&currentPage=1&p_initep=");
      out.print(loggedUserId);
      out.write("\" target=\"innerworkarea\">");
      out.print(GlobalContext.getMessageForWeb("instlist.my_req_proc", loggedUserLocale));
      out.write("</a></li>\r\n");
      out.write("        </ul>\r\n");
      out.write("        ");
	for (int i=0; i<workitemFilters.length; i++) {
      ...
      out.write("\t\t\t\t<a href=\"");
      out.print(GlobalContext.WEB_CONTEXT_ROOT);
      out.write("/processparticipant/worklist/wl2_instanceList.jsp?filtering=");
      out.print(instanceFiltering);
      out.write("&currentPage=1&processDefinition=");
      out.print(instanceDefId);
      out.write("&endpointType=");
      out.print(instanceEndpointType);
      out.print(instanceInfoParameter);
      out.write("\" target=\"innerworkarea\">");
      out.print(workitemFilters[i].getFilterName());
      out.write("</a>&nbsp;&nbsp;\r\n");
      out.write("\t\t");
      ...
      out.print(workitemFilters[i].getFilterUId());
