...
<%
	...
	String url = "/processparticipant/worklist/workitemHandler.jsp?taskId="+taskId+"&instanceId="+processInstance+"&tracingTag="+tracingTag;
	
	if (saveOnly) {
		session.getServletContext().getRequestDispatcher(url).forward(request, response);
	} else {
		url = GlobalContext.WEB_CONTEXT_ROOT + url;
	}
%>
<html>
<head>
...
<script type="text/javascript">
	...
	function viewProcess() {
		...
		var url = "../../processparticipant/viewProcessInformation.jsp?type=no&option=on&omitHeader=yes&instanceId=<%=processInstance%>";
		window.location.href = url;
	}
        ...
        <tr> 
          <td align="center">
          	...
          	<table  width="709" height="348" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td colspan="3"><img src="../../images/Common/consequence_01_<%=loggedUserLocale%>.gif" width="709" height="196" alt=""></td>
                </tr>
                <tr>
                    <td><img src="../../images/Common/consequence_02.gif" width="87" height="66" alt=""></td>
                    <td width="385" height="66" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        if(UEngineUtil.isNotEmpty(nextAct)){
	                        ...
	                        %>
	                            ...
	                            <td><img src="../../images/Common/i_blue01.gif" width="5" height="7"> <%=GlobalContext.getLocalizedMessageForWeb("next_work", loggedUserLocale, "Next Work") %></td>
	                            <td>: <%=nextAct %></td>
	                        </tr>
	                        <tr height="25">
	                            <td><img src="../../images/Common/i_blue01.gif" width="5" height="7"> <%=GlobalContext.getLocalizedMessageForWeb("worker_name", loggedUserLocale, "Worker Name") %></td>
	                            <td>: <%=workerName %></td>
	                        </tr>
                        <%
                        }
                    ...
                    <td><img src="../../images/Common/consequence_04.gif" width="237" height="66" alt=""></td>
                </tr>
                <tr>
                    <td colspan="3"><img src="../../images/Common/consequence_05.gif" width="709" height="86" alt=""></td>
                </tr>
            </table>
