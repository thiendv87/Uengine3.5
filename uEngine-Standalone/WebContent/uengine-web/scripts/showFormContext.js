...
function delegateSearchPeople(){
		...
		var orgPicker = window.open(WEB_ROOT + '/common/organizationChartPicker.jsp','_new','width=430,height=550,resizable=true,scrollbars=no');
...
function onDelegateWorkitem(selectedPeople){ 
	...
	document.mainForm.all[inputName].value =ids;		
	document.mainForm.action='../wihDefaultTemplate/delegateWorkItem.jsp';
