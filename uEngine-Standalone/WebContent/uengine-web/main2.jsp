        ...
        <tr>
            <td width="245" valign="top"><div id="leftsec">
                    ...
                    <table width="225" height="195" border="0" cellpadding="0" cellspacing="0" background="images/main/BusinessBox_<%=loggedUserLocale%>.jpg">
                        ...
                        <tr>
                            <td valign="top"><table id="dashboardCount">
                                </table></td>
                        </tr>
                    </table>
                    <br />
                            ...
                            <td class="padding19"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <td width="80" align="right" valign="top" style="padding:5px 0 0 0;"><a href="processparticipant/worklist/index.jsp?type=instancelist&filtering=0" target="_parent"><img src="images/main/b_more.gif" width="41" height="14"></a></td>
                                        </tr>
                                        <tr>
                                            <td height="2" colspan="3" bgcolor="2b72a4"></td>
                                        </tr>
                                        <tr>
                            ...
                            <td class="padding19"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <td width="50%" align="left" >&nbsp;</td>
                                            <td width="80" align="right" valign="top" style="padding:5px 0 0 0;"><a href="processparticipant/worklist/index.jsp?type=instancelist&filtering=1" target="_parent"><img src="images/main/b_more.gif" width="41" height="14"></a></td>
                                        </tr>
                                        <tr>
                                            <td height="2" colspan="3" bgcolor="2b72a4"></td>
                                        </tr>
